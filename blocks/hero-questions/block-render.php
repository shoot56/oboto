...
$wrapper_attributes = get_block_wrapper_attributes([
 ...
 if ( get_field( 'add_animation' ) == 1 ) {
    ...
    $delay = "100";
    $aos_args = 'data-aos="' . $data_aos . '" data-aos-delay="' . $delay . '" data-aos-mirror="true" data-aos-once="false" data-aos-easing="ease-in-out"   data-aos-duration="500"   data-aos-anchor-placement="center-center" ';
 }
