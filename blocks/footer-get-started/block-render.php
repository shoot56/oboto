...
$wrapper_attributes = get_block_wrapper_attributes([
 ...
 if ( get_field( 'add_animation' ) == 1 ) {
    ...
    $delay = "1000";
    $aos_args = 'data-aos="' . $data_aos . '" delay="'.$delay.'" data-aos-anchor-placement="top-bottom" data-aos-offset= "-200" data-aos-mirror="true" data-aos-once="false" data-aos-easing="ease-in-out"';
 }
